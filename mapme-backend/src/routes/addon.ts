...
/**
 * Transforms a server-side addon object to the frontend-compatible format
 */
...
/**
 * Update the status of an addon for the authenticated user
 */
